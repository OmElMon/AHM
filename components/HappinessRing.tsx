...
export function HappinessRing({ score = 84 }: { score?: number }) {
  ...
  return <View style={styles.wrap}>
    <Svg width={size} height={size} style={StyleSheet.absoluteFill}>
      <Defs><LinearGradient id="ring" x1="0" y1="0" x2="1" y2="1"><Stop offset="0" stopColor="#F2B2C1"/><Stop offset="1" stopColor="#D96C89"/></LinearGradient></Defs>
      <Circle cx={size/2} cy={size/2} r={r} stroke="#F8E8EA" strokeWidth={stroke} fill="none" />
...
const styles = StyleSheet.create({
  ...
  score: { fontFamily: 'CormorantGaramond_700Bold', fontSize: 65, lineHeight: 68, color: colors.ink },
