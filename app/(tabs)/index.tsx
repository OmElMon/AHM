...
export default function Today() {
  ...
  return <Screen>
    ...
    <LinearGradient colors={['#FFFFFF', '#FFE1ED', '#F1E4FF']} locations={[0, .62, 1]} start={{x:0,y:0}} end={{x:1,y:1}} style={styles.hero}>
...
const styles = StyleSheet.create({
  ...
  hello: { fontFamily: 'BodoniModa_700Bold', fontSize: 30, color: colors.ink, marginTop: 4 },
  ...
  hero: { borderRadius: 32, padding: 22, borderWidth: 1.5, borderColor: '#FFB6D3', ...shadow }, heroTop: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' },
  heroTitle: { fontFamily: 'BodoniModa_700Bold', fontSize: 24, color: colors.ink, marginTop: 3 }, streak: { flexDirection: 'row', backgroundColor: '#24101D', paddingHorizontal: 11, paddingVertical: 7, borderRadius: 15, gap: 5 }, streakText: { fontFamily: 'DMSans_700Bold', fontSize: 11, color: '#FFFFFF' },
  ...
  sectionHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 28, marginBottom: 13 }, sectionTitle: { fontFamily: 'BodoniModa_700Bold', fontSize: 23, color: colors.ink }, sectionLink: { fontFamily: 'DMSans_600SemiBold', color: colors.rose, fontSize: 12 },
  ...
  quote: { fontFamily: 'BodoniModa_700Bold_Italic', fontSize: 17, textAlign: 'center', color: '#5D2541', marginTop: 30, paddingHorizontal: 32 }, quoteBy: { fontFamily: 'DMSans_700Bold', fontSize: 8, letterSpacing: 1.5, textAlign: 'center', color: colors.rose, marginTop: 7, marginBottom: 12 },
});
